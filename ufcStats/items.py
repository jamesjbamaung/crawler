...
class FightsItem(scrapy.Item):
    ...
    perRoundStatsTotal_fighter1_kd = scrapy.Field()
    perRoundStatsTotal_fighter1_sigstr = scrapy.Field()
    perRoundStatsTotal_fighter1_sigstrper = scrapy.Field()
    perRoundStatsTotal_fighter1_totstr = scrapy.Field()
    perRoundStatsTotal_fighter1_td = scrapy.Field()
    perRoundStatsTotal_fighter1_tdper = scrapy.Field()
    perRoundStatsTotal_fighter1_subatt = scrapy.Field()
    perRoundStatsTotal_fighter1_pass = scrapy.Field()
    perRoundStatsTotal_fighter1_rev = scrapy.Field()
    perRoundStatsTotal_fighter2_kd = scrapy.Field()
    perRoundStatsTotal_fighter2_sigstr = scrapy.Field()
    perRoundStatsTotal_fighter2_sigstrper = scrapy.Field()
    perRoundStatsTotal_fighter2_totstr = scrapy.Field()
    perRoundStatsTotal_fighter2_td = scrapy.Field()
    perRoundStatsTotal_fighter2_tdper = scrapy.Field()
    perRoundStatsTotal_fighter2_subatt = scrapy.Field()
    perRoundStatsTotal_fighter2_pass = scrapy.Field()
    perRoundStatsTotal_fighter2_rev = scrapy.Field()
    perRoundStatsSig_fighter1_head = scrapy.Field()
    perRoundStatsSig_fighter1_body = scrapy.Field()
    perRoundStatsSig_fighter1_leg = scrapy.Field()
    perRoundStatsSig_fighter1_distance = scrapy.Field()
    perRoundStatsSig_fighter1_clinch = scrapy.Field()
    perRoundStatsSig_fighter1_ground = scrapy.Field()
    perRoundStatsSig_fighter2_head = scrapy.Field()
    perRoundStatsSig_fighter2_body = scrapy.Field()
    perRoundStatsSig_fighter2_leg = scrapy.Field()
    perRoundStatsSig_fighter2_distance = scrapy.Field()
    perRoundStatsSig_fighter2_clinch = scrapy.Field()
    perRoundStatsSig_fighter2_ground = scrapy.Field()
    bonus_ko = scrapy.Field()
    bonus_sub = scrapy.Field()
    bonus_perf = scrapy.Field()
    bonus_fight = scrapy.Field()
    bonus_belt = scrapy.Field()
